...
import {
  deleteUserUsingPost as deleteUser,
...
import {listGeneratorByPageUsingPost} from "@/services/backend/generatorController";
  ...
  const columns: ProColumns<API.Generator>[] = [
    ...
    },
    {
      ...
      renderFormItem: (schema) => {
        ...
        //@ts-ignore
        return <Select mode="tags" {...fieldProps}></Select>
      }
    },
    {
      title: '图片',
