...
/** testDownload GET /api/file/test/download */
...
/** testUpload PUT /api/file/test/upload */
export async function testUploadUsingPut(body: {}, file?: File, options?: { [key: string]: any }) {
